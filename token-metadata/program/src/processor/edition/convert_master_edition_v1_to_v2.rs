...
pub fn process_convert_master_edition_v1_to_v2(
    ...
    assert_owner_in(one_time_printing_auth_mint_info, &mpl_utils::token::TOKEN_PROGRAM_IDS)?;
    ...
    let auth_mint = token_unpack::<Mint>(&one_time_printing_auth_mint_info.try_borrow_data()?)?.base;
