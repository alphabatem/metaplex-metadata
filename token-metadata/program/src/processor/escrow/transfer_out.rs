...
pub fn process_transfer_out_of_escrow(
    ...
    let attribute_src = StateWithExtensions::<Account>::unpack(&attribute_src_info.data.borrow())?.base;
    ...
    let escrow_account = StateWithExtensions::<Account>::unpack(&escrow_account_info.data.borrow())?.base;
    ...
    let attribute_dst = StateWithExtensions::<Account>::unpack(&attribute_dst_info.data.borrow())?.base;
